    ...
    <main className="container py-8">
      ...
      <div className="rounded-xl border bg-card overflow-hidden">
        <table className="w-full text-right">
          <thead className="bg-secondary/50"><tr className="text-sm"><th className="p-3">الاسم</th><th className="p-3">تاريخ الوصول</th><th className="p-3">عدد عمليات التحقق</th><th className="p-3">آخر مبلغ</th><th className="p-3">عرض</th></tr></thead>
          <tbody className="divide-y">
            ...
            {list.length === 0 && (<tr><td colSpan={5} className="p-6 text-center text-muted-foreground">لا توجد عاملات في هذا الفرع.</td></tr>)}
          </tbody>
          <tfoot><tr className="bg-muted/40 font-semibold"><td className="p-3" colSpan={3}>إجمالي آخر المبالغ</td><td className="p-3">₱ {totalLastPayments}</td><td /></tr></tfoot>
        </table>
      </div>
    </main>
  );
