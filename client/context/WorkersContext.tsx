  ...
  useEffect(() => {
    ...
    const loadBranchData = async (branchId: string) => {
      ...
      try {
        ...
        // Fetch workers for this specific branch
        ...
        // Fetch all verifications (will be filtered by worker IDs in state)
    ...
    // Load workers when branch is selected
    useEffect(() => {
      if (selectedBranchId && supabase && isMounted) {
